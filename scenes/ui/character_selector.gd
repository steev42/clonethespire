...
const ASSASSIN_STATS := preload("res://combatants/characters/assassin/assassin.tres")
const WARRIOR_STATS := preload("res://combatants/characters/warrior/warrior.tres")
const WIZARD_STATS := preload("res://combatants/characters/wizard/wizard.tres")
...
func _on_start_button_pressed() -> void:
	print("Start game as ", current_character.character_name)
